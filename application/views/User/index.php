<style>
    ...
    .head-dsb p {;color: #fff;}
    .dsb-id { margin-top: 0.08rem;}
    
    .panel2 {width: 100%; height: 12%; margin-top: 0.26rem; background-color: #fff;}
    .panel2 ul {list-style: none;}
    .panel2 ul li { position: relative; float: left; width: 30%; height: 28px; text-align: center; margin-left: 10px;}
    ...
    .panel3 .weui_cell_bd p, .panel4 .weui_cell_bd p, .panel5 .weui_cell_bd p {margin: 0px; color: #838383;}
